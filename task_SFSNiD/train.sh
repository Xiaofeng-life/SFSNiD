...
python train_SFSNiD_supervised.py --results_dir ../results/MyNightDehazing/train_SFSNiD_supervised/UNREAL_NH/ --img_h 256 --img_w 256 --train_batch_size 4 --dataset UNREAL_NH --total_epoches 100 --lr 0.0001 --device cuda:0 --num_res 3
